...
public class DictoryJsonFactory {
	...
	public static JSONObject toJsonObject(Dictory model) {
		...
		if (model.getExt5() != null) {
			...
			jsonObject.put("ext5_datetime", DateUtils.getDateTime(model.getExt5()));
		}
		if (model.getExt6() != null) {
			...
			jsonObject.put("ext6_datetime", DateUtils.getDateTime(model.getExt6()));
		}
		if (model.getExt7() != null) {
			...
			jsonObject.put("ext7_datetime", DateUtils.getDateTime(model.getExt7()));
		}
		if (model.getExt8() != null) {
			...
			jsonObject.put("ext8_datetime", DateUtils.getDateTime(model.getExt8()));
		}
		if (model.getExt9() != null) {
			...
			jsonObject.put("ext9_datetime", DateUtils.getDateTime(model.getExt9()));
		}
		if (model.getExt10() != null) {
			...
			jsonObject.put("ext10_datetime", DateUtils.getDateTime(model.getExt10()));
		}
