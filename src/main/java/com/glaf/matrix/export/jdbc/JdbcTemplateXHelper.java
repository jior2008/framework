 ...
 */
public class JdbcTemplateXHelper {
	protected final static Log logger = LogFactory.getLog(JdbcTemplateXHelper.class);
	...
	public JdbcTemplateXHelper(ExportApp exportApp, Database database) {
	...
	public List<Map<String, Object>> images(String name, Object... args) {
		return this.imagesInner(database, name, args);
	}
	 ...
	 * @return
	 */
	public List<Map<String, Object>> imagesInner(Database database, String name, Object... args) {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> imagesx(String mapping, String name, Object... args) {
		IDatabaseService databaseService = ContextFactory.getBean("databaseService");
		try {
			Database database = databaseService.getDatabaseByMapping(mapping);
			if (database != null) {
	...
	public List<Map<String, Object>> queryInner(Database database, String name, Object... args) {
		List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
		if (database == null) {
			throw new JxlsException("Null jdbc connection");
		}
