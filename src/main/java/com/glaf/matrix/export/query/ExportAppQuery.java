...
public class ExportAppQuery extends DataQuery {
	...
	public ExportAppQuery() {

	}

	public ExportAppQuery active(String active) {
		if (active == null) {
	...
	public ExportAppQuery templateId(String templateId) {
		if (templateId == null) {
	...
	public ExportAppQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public ExportAppQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public ExportAppQuery deploymentId(String deploymentId) {
	...
	public ExportAppQuery deploymentIds(List<String> deploymentIds) {
	...
	public ExportAppQuery nodeId(Long nodeId) {
		if (nodeId == null) {
	...
	public ExportAppQuery nodeIds(List<Long> nodeIds) {
		if (nodeIds == null) {
	...
	public ExportAppQuery syncFlag(String syncFlag) {
		if (syncFlag == null) {
	...
	public ExportAppQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public ExportAppQuery type(String type) {
		if (type == null) {
	...
	public ExportAppQuery uniqueFlag(String uniqueFlag) {
		if (uniqueFlag == null) {
	...
	public ExportAppQuery updateBy(String updateBy) {
		if (updateBy == null) {
	...
	public ExportAppQuery updateTimeGreaterThanOrEqual(Date updateTimeGreaterThanOrEqual) {
	...
	public ExportAppQuery updateTimeLessThanOrEqual(Date updateTimeLessThanOrEqual) {
