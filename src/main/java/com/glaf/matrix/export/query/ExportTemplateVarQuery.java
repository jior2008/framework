...
public class ExportTemplateVarQuery extends DataQuery {
	...
	public ExportTemplateVarQuery() {

	}

	public ExportTemplateVarQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public ExportTemplateVarQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public ExportTemplateVarQuery deploymentId(String deploymentId) {
	...
	public ExportTemplateVarQuery deploymentIds(List<String> deploymentIds) {
	...
	public ExportTemplateVarQuery expId(String expId) {
		if (expId == null) {
	...
	public ExportTemplateVarQuery expIds(List<String> expIds) {
		if (expIds == null) {
