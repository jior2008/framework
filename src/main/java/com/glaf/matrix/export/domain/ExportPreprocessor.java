...
@Entity
@Table(name = "SYS_EXPORT_PREPROCESSOR")
public class ExportPreprocessor implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExportPreprocessor other = (ExportPreprocessor) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public ExportPreprocessor jsonToObject(JSONObject jsonObject) {
		return ExportPreprocessorJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return ExportPreprocessorJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return ExportPreprocessorJsonFactory.toObjectNode(this);
	}
