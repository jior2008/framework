...
public class SnowflakeIdWorker {
	...
	public synchronized long nextId() {
		...
		/** 时间截向左移22位(5+5+12) */
		long timestampLeftShift = sequenceBits + workerIdBits + datacenterIdBits; /** 数据标识id向左移17位(12+5) */
		long datacenterIdShift = sequenceBits + workerIdBits; /** 机器ID向左移12位 */long workerIdShift = sequenceBits;
