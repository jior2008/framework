...
public abstract class Hash {
	 ...
	 * symbolic constant. Currently two function types are supported, "jenkins" and
	 * "murmur".
	 * 
	 * @param name
	 *            hash function name
	...
	/**
	 * Calculate a hash using all bytes from the input argument, and a provided seed
	 * value.
	 * 
	 * @param bytes
	 *            input bytes
	...
	/**
	 * Calculate a hash using bytes from 0 to <code>length</code>, and the provided
	 * seed value
	 * 
	 * @param bytes
	 *            input bytes
